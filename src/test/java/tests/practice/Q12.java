...
public class Q12 extends TestBase
{
    ...
    // bu site her arama yaptigimizda yeniden login olmamizi istiyor
    // burada kullanıcı olarak kutuyu siler yeniden arama yapariz ancak
    // data provider kullanirken clear yapamiyoruz
    // aramakutusuna kadar getiren adımlari atlayıp sadece deger yazdigimiz satirdan baslatarak provider'dan data alamayuiz
    // test methodumuz yukaridan asagiya calismak zorundadir
}
