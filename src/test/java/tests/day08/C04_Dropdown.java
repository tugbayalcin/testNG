...
public class C04_Dropdown
{
    ...
    public void test1(){
        ...
        // burada Select select = new Select(dropdownElementi) desem hata vermez
        // cunku burasi baska bir scop, ve ben yalnizca burada gecerli bir select objesi olusturmus olurum ve
        // yukaridakini kullanammis olurum
        // eger yalnizca select = new diyerak yapiyorsam, class seviyesinde tanimlamis oldugum objeyi kullaniyorum demektir
